...
const AdminLandingPage = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="admin-page modern-layout">
        <div className="candidates-section modern-section">
          <h2 className='section-title'>Candidates Overview</h2>
        ...
        <div className="admin-form modern-form">
          <h2>Add Candidate</h2>
